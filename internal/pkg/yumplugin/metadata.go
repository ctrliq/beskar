...
func (r *repoMetadata) Save(remoteOptions ...remote.Option) error {
	pushRef, err := name.ParseReference(filepath.Join(r.registry, r.repository+":latest"))
	if err != nil {
		return err
	}
	...
	return oras.Push(metadataPusher, remoteOptions...)
}
